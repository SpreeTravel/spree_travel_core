...
function VariantOptions(options, allow_backorders) {
  ...
  function find_variant() {
    ...
    if (selected.length == divs.length) {
      ...
      if (prices.length == 1) { 
	$('#product-price .price').html('<span class="price assumed">' + prices[0] + '</span>');//TODO aqui es que teng que convertirel valor, multiplicarlo y luego ponerlo....
      } else { 
