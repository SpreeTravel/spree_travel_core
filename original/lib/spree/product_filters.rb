...
###    # 2) Add it to the config load path, or require it in an initializer, e.g...                           i
###    #
...
###        #    end
###        #    Spree::Product.joins(:master).where(scop
###        #end
###
...
###            #end
###
###            MetaSearch::Searches::Spree_Product.class_eval do
###                def brand_any(*opts)
