...
function fill_cart_hiddens_package(product_id, variant_id, combination_id) {
    theform = $('.inside-room-cart-form-'+variant_id+'-'+combination_id);
    template = $('#template-hidden-'+variant_id+'-'+combination_id, theform);
    data = params_data_room(product_id, variant_id);
